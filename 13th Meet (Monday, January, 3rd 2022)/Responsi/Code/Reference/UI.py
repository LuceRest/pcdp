...
# frmImgTopHat.pack_propagate(0)
# frmImgTopHat.pack(side="left", padx=10, pady=(20,2))
...
# frmImgBlackHat.pack_propagate(0)
# frmImgBlackHat.pack(side="left", padx=10, pady=(20,2))
...
btnClosing = ttk.Button(frmBtnMid, text='Closing', style='success.TButton', cursor="hand2", width=12)
...
btnTopHat = ttk.Button(frmBtnBottom, text='Top Hat', style='success.TButton', cursor="hand2", width=12)
btnTopHat.grid(row=0, column=3, padx=(85,0), pady=(10,0))
# btnTop Hat.pack(side='top', pady=(10,0))
...
# btnBlackHat.pack(side='top', pady=(10,0))
...
# lblResultTopHat.grid(row=0, column=0)

lblResultBlackHat = ttk.Label(frmImgBlackHat)
# lblResultBlackHat.grid(row=0, column=0)
