...
if __name__ == '__main__':
    ...
    valueDefault = tk.IntVar(value=2)      # Holds an int; default value 0
    txtStElSize = ttk.Entry(frmBtnBottom, font="Normal 10",style='info.TEntry', width=7, textvariable=valueDefault)
